...
<div class="dir">
<form action="movimentar-solicitacao.php" method="post">
<button class="ui blue image label" type="submit">
...
<b>Observação</b><br><br>
    <div class="ui form">
    <textarea style="resize:none" name="observacao" required></textarea>
    </div>
  </div>
...
<br>
    <b>Status</b><br><br>
    <select class="dropba" name="status" style="margin-top:-5px">
